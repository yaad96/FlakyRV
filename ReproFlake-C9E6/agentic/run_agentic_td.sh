...
#
# Agentic TD repair pipeline. The agent iterates through context tools and
...
# STEP 4d — Run FlakyCodeChange to capture failure log
MVNOPTS='-DfailIfNoTests=false -Dgpg.skip=true -Dcheckstyle.skip -Drat.skip -Denforcer.skip -Dmaven.javadoc.skip'

echo "[step 4d] /app/work/FlakyCodeChange -> /app/work/traces-flakycc (failure log)"
