...
#
# Agentic OD repair pipeline. The orchestrator runs an iterative tool-use
# loop with bounded submit_patch attempts.
#
...
# ============================================================
# STEP 4d — Run Flaky to capture initial failure log
# ============================================================
