...
public class Event {
	...
	String retString = "(Event)\n";
        retString += ("Modifiers: " + String.join(", ", modifiers) + "\n");
        retString += ("Name: " + name + "\n");
        retString += ("DefinitionModifiers: " + String.join(", ", definitionModifiers) + "\n");
        retString += ("Definition: " + definition + "\n");
        retString += ("Pointcut: " + pointcut + "\n");
        retString += ("Action: " + action + "\n");
	return retString;
    }
