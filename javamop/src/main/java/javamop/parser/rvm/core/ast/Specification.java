...
public class Specification {
	...
	String retString = "(Specification)\n";
        retString += ("PreDeclarations: " + preDeclarations + "\n");
        retString += ("LanguageModifiers: " + String.join(", ", languageModifiers) + "\n");
        retString += ("Name: " + name + "\n");
        retString += ("LanguageParameters: " + languageParameters + "\n");
        retString += ("LanguageDeclarations: " + languageDeclarations + "\n");
	for (Event e: events) {
