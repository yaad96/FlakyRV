...
def _three_outputs_spec_lines():
    ...
    out.append("  2. What does the FAILURE OUTPUT (stack trace, assertion mismatch) and")
    out.append("     the VICTIM TEST SOURCE / PRODUCTION CODE shown above tell you about")
    out.append("     *what* the failing run is doing differently?")
...
def assemble_context_td(result_container):
    ...
    out.append("cause from the failure stack trace, and produce")
