...
def _three_outputs_spec_lines():
    ...
    out.append("  3. What do the TOP DISTINCTIVE CLEAN-ONLY trace sequences and the")
    out.append("     SOURCE-LEVEL LOCATION MISMATCHES (in the RV TRACE ANALYSIS section")
    out.append("     above) suggest about the missing cleanup site? CAVEAT: for NIO bugs")
    out.append("     driven by static-primitive pollution, the RV trace diff is often")
    out.append("     empty — if it is, treat the test source as primary evidence.")
    out.append("  4. WHY does the second invocation's assertion observe a different value")
    ...
    out.append("  5. The smallest cleanup statement that resets the field — append it to")
